...
def verify_routemap_set_origin_1(step, switch1, switch2):
    ...
    configure_route_map_set_origin(switch1, "BGP_OUT1", as_num1, origin)
    ...
    configure_neighbor_rmap_out(switch1, as_num1, ip_addr2, as_num1,
                                "BGP_OUT1")
    ...
    assert (set_origin_flag is True), "Failed to configure set origin"
    step("\"set origin\" running succesfully")


def verify_routemap_set_origin_2(step, switch1, switch2):
    ...
    configure_route_map_match_origin(switch2, "BGP_IN1", as_num2, origin)
    ...
    configure_neighbor_rmap_in(switch2, as_num2, ip_addr1, as_num1, "BGP_IN1")
...
@mark.timeout(600)
def test_bgp_ft_routemap_origin(topology, step):
    ...
    verify_routemap_set_origin_1(step, ops1, ops2)
    verify_routemap_set_origin_2(step, ops1, ops2)
