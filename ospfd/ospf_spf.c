...
#ifdef ENABLE_OVSDB
  long spf_ts = 0;
  int spf_count = area->spf_calculation;
  spf_ts = (1000000 * area->ts_spf.tv_sec + area->ts_spf.tv_usec)/1000;
  ovsdb_ospf_set_spf_statistics (area->ospf->ospf_inst,area->area_id,
                          spf_ts,spf_count);
#endif
