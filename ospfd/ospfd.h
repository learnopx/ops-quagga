...
#ifdef ENABLE_OVSDB
  /* OSPF process Enable/Disable flag */
  #define OSPF_PROCESS_DISABLE       0
  #define OSPF_PROCESS_ENABLE        1

  /* OSPF process enable flag */
  u_char ospf_en;

  /* OSPF instance numner will be used for mapping to VRF instance */
  int64_t ospf_inst;
#endif
};
...
#ifdef ENABLE_OVSDB
extern struct ospf* ospf_lookup_by_instance (int64_t ospf_instance);
#endif
