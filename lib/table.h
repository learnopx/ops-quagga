 ...
 */
#define RETAIN_MODE_ROUTE_IN_KERNEL_AFTER_RESTART 0x01

/*
 * Mark the route seen in kernel with this flag which does
 * not change after restart
 */
#define RETAIN_MODE_ROUTE_NO_CHANGE_AFTER_RESTART 0x02

/*
 * Mark the route seen in kernel with this flag which
 * changes after restart
 */
#define RETAIN_MODE_ROUTE_CHANGE_AFTER_RESTART 0x04
#endif
